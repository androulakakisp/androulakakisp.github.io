...
~[Light Weight Space Ship (LWSS)](./images/lwss.gif){width=100%}

![Bun](./images/bun.gif){width=100%}
...
::: {layout-ncol=2}
![Broken Gray Counter](./images/broken_gray_counter.gif){width=100%}

![LWSS-LWSS Bounce](./images/lwss_lwss_bounce.gif){width=100%}
:::

And just because I had to try, here are two examples of what happens when you initialize with a random state.
::: {layout-ncol=2}
![Random Initialization 1](./images/random_1.gif){width=100%}

![Random Initialization 2](./images/random_2.gif){width=100%}
:::